...
option = {
    ...
    visualMap: {
        ...
        text: ['高', '低'],
        pieces: [
            { gt: 100, label: '>100人', color: '#7f1100' },
            { gte: 10, lte: 100, label: '10-100人', color: '#ff5428' },
            { gte: 1, lt: 10, label: '1-9人', color: '#ff8c71' },
    ...
    geo: {
        ...
        zoom: 1.23,
        top: 120,
        label: { normal: { show: true, fontSize: '14', color: 'rgba(0,0,0,0.7)' } },
        itemStyle: {
